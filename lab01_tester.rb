...
if  File.exists?("/usr/home/grads/courses/myy402/bin/Mars4_5.jar")
    ...
    ##########################################
    tester = MIPSTester::MIPS.new :mars_path => "C:\Users\Pantelis\Desktop/Mars4_5.jar"
end


tester.test "../lab01.asm" do
  # The expected register values at the end of execution are placed here
  expect :s0 => 0xffffffff, :s1 => 0x00000ff, :s2 => 0x1001002c, :t0 => 0x10010050,
		  '0x10010024' => 0x00000006, '0x10010038' => 0x00000006, '0x1001003c' => 0x10010028
